...
export const SUPPORTED_FORMATS = {
  ...
  // PDF format (read text extraction, write)
  pdf: { name: 'PDF', desc: 'PDF Document (Text)', icon: 'fa-file-pdf', read: true, write: true, category: 'document' },
};
...
async function readFileContent(file, extension) {
  return new Promise((resolve, reject) => {
    ...
    if (['xlsx', 'xls', 'docx', 'pdf'].includes(extension)) {
